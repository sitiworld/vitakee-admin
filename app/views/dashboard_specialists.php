                    ...
                    <div class="row">
                        <div class="col-6">
                            <div
                                ...
                                <span class="mdi mdi-account-outline text-kpi-person" style="font-size: 24px;"></span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div
                                ...
                                <span class="dripicons-bell" style="font-size: 24px; color: #3EBBD0;"></span>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center flex-column col-6">
                            <div class="text-end">
                    ...
                    <div class="card-body">
                        <div class="px-2 d-flex flex-wrap w-100 align-items-center justify-content-between gap-2">
                            <div class="d-flex w-md-50 flex-wrap align-items-center gap-2">
                                ...
                                <select class="form-select flex-grow-2" name="id_biomarker" id="id_biomarker"
                                    style="width: 150px;">
                                    <option value="">
                                ...
                                <select class="form-select flex-grow-1" name="status_range" style="width: 80px;"
                                    id="status_range">
                                    <option value="">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="allUsersTable" data-toggle="table" data-search="true" data-show-refresh="true"
                            data-page-list="[5, 10, 20]" data-page-size="5" data-show-columns="true"
                            data-pagination="true" data-url="" data-show-pagination-switch="true"
                            class="table-borderless" data-locale="<?= $locale ?>">
                            <thead class="">
                                <tr>
                                    ...
                                    <th data-field="status" data-class="text-center" data-formatter="statusFormatter">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="topUsersTable" data-toggle="table" data-search="true" data-show-refresh="true"
                            data-page-list="[5, 10, 20]" data-page-size="5" data-show-columns="true"
                            ...
                            <thead class="">
                                <tr>
                                    ...
                                    <th data-field="id" data-align="center" data-formatter="actionFormatterTop">
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch(`specialist/session/${userId}`, {
            method: 'GET',
            headers: {
            ...
            .then(data => {
                ...
                if (data.value === true) {
                    ...
                    let greeting = `${greetings[lang].hello}, ${user.title_name} ${user.first_name} ${user.last_name}`;
