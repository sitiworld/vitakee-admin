...
CREATE TRIGGER trg_administrators_update
...
BEGIN
  ...
  IF OLD.first_name <> NEW.first_name THEN
    ...
    INSERT INTO audit_log (
      ...
      'administrators', OLD.id, 'UPDATE', @user_id,
      change_data, NULL,
      @client_ip, @client_hostname, @user_agent,
      @client_os, @client_browser,
      @domain_name, @request_uri, @server_hostname
...
CREATE TRIGGER trg_administrators_delete
...
BEGIN
  INSERT INTO audit_log (
    ...
    'administrators', OLD.id, 'DELETE_PHYSICAL', @user_id,
    NULL, JSON_OBJECT(
...
CREATE TRIGGER trg_administrators_delete_logical
AFTER UPDATE ON administrators
FOR EACH ROW
BEGIN
  IF NEW.deleted_at IS NOT NULL AND OLD.deleted_at IS NULL THEN
    INSERT INTO audit_log (
      ...
      'administrators', OLD.id, 'DELETE_LOGICAL', @user_id,
