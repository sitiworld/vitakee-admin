...
-- Tiempo de generación: 17-09-2025 a las 22:42:37
...
-- Funciones
--
CREATE DEFINER=`vitakee_developer`@`%` FUNCTION `escape_json` (`val` TEXT) RETURNS TEXT CHARSET utf8mb4 COLLATE utf8mb4_general_ci DETERMINISTIC BEGIN
    IF val IS NULL THEN
        RETURN '';
    END IF;
...
CREATE TABLE `second_opinion_data` (
  ...
  `second_opinion_id` char(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
('1', 'fdf23cb0-86f1-4902-85e3-c20a1f481835', '/uploads/certifications/cert_6866ef7b212e3.png', 'fsfafa', 'fsafafasssss', 0, '2025-07-03 13:39:53', '1', '0000-00-00 00:00:00', '1', NULL, NULL),
('2', 'fdf23cb0-86f1-4902-85e3-c20a1f481835', '/uploads/certifications/cert_6866eab6dbbe4.pdf', 'fsafa', 'fsafass', 1, '2025-07-03 13:40:22', '1', '0000-00-00 00:00:00', '1', NULL, NULL),
('b9113b2d-fdcb-49f9-aada-4be380b329ae', 'fdf23cb0-86f1-4902-85e3-c20a1f481835', '/uploads/certifications/cert_686dac7cb759c.pdf', 'fdsafa', 'fsafa', 1, '2025-07-08 16:40:44', 'fdf23cb0-86f1-4902-85e3-c20a1f481835', NULL, NULL, NULL, NULL);
...
CREATE TABLE `specialist_locations` (
  ...
  `specialist_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `city` char(36) DEFAULT NULL,
  `state` char(36) DEFAULT NULL,
  `country` char(36) DEFAULT NULL,
...
CREATE TRIGGER `trg_specialist_locations_update` AFTER UPDATE ON `specialist_locations` FOR EACH ROW BEGIN
  ...
  IF OLD.city <> NEW.city THEN
    SET change_data = CONCAT(
      change_data, IF(change_data = '{', '', ','),
      '"city":{"old":"', escape_json(OLD.city), '","new":"', escape_json(NEW.city), '"}'
    );
  END IF;
  ...
  IF OLD.state <> NEW.state THEN
    SET change_data = CONCAT(
      change_data, IF(change_data = '{', '', ','),
      '"state":{"old":"', escape_json(OLD.state), '","new":"', escape_json(NEW.state), '"}'
    );
  END IF;
  ...
  IF OLD.country <> NEW.country THEN
    SET change_data = CONCAT(
      change_data, IF(change_data = '{', '', ','),
      '"country":{"old":"', escape_json(OLD.country), '","new":"', escape_json(NEW.country), '"}'
    );
  END IF;
...
ALTER TABLE `specialist_locations`
  ...
  ADD KEY `specialist_id` (`specialist_id`),
  ADD KEY `idx_spec_loc_country` (`country`),
  ADD KEY `idx_spec_loc_state` (`state`),
  ADD KEY `idx_spec_loc_city` (`city`);
...
--
ALTER TABLE `specialist_locations`
  ADD CONSTRAINT `fk_spec_loc_city` FOREIGN KEY (`city`) REFERENCES `cities` (`city_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_spec_loc_country` FOREIGN KEY (`country`) REFERENCES `countries` (`country_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_spec_loc_state` FOREIGN KEY (`state`) REFERENCES `states` (`state_id`) ON DELETE SET NULL ON UPDATE CASCADE,
