...
;(function () {
  ...
  config['layout']['mode'] =
    layoutMode != null ? layoutMode : defaultConfig.layout.mode

  var layoutWidth = this.html.getAttribute('data-layout-width')
  config['layout']['width'] =
    layoutWidth != null ? layoutWidth : defaultConfig.layout.width
  ...
  config['menu']['icon'] =
    menuIcon !== null ? menuIcon : defaultConfig.menu.icon

  var twocolumnColor = this.html.getAttribute('data-two-column-color')
  config['sidenav']['twocolumn'] =
    twocolumnColor !== null ? twocolumnColor : defaultConfig.sidenav.twocolumn
